...
class Layer(object):
    ...
    def _default_config_params(self):
        ...
        params['merged_act'] = "true" if self.get_merged_act() else "false"
    ...
    def get_merged_act(self):
        return self.merged_act

    def set_merged_act(self, merged_act):
        self.merged_act = merged_act # Bool flag to set merged_act    
